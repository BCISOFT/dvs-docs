...
Commandes utilisables avec la recette Prestashop
...
- **[employee-password](employee-password)** - Modifie le mot de passe d'un compte employé
- **[img-proxy](img-proxy)** - Gestion du proxy d'images
