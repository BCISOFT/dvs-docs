...
Affiche ou change le registre actif. Affiche le dépôt en cours si appelé sans paramètre.
...
`Option` est optionnel et parmi:

- `logout`: déconnection du registre (options pro)
